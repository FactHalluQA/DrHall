...
def answer_in_dutch(question: Question) -> list[ChatSlice]:
    """
    ...
    chat_slice = answer_in_dutch_step_1(question)
...
def answer_in_dutch_step_1(question: Question, prompt: str = "") -> ChatSlice:
    if not prompt:
    ...
    question.dutch = chat_slice.answer
    return chat_slice
