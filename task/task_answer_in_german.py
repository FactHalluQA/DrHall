...
def answer_in_german(question: Question) -> list[ChatSlice]:
    """
    ...
    chat_slice = answer_in_german_step_1(question)
...
def answer_in_german_step_1(question: Question, prompt: str = "") -> ChatSlice:
    if not prompt:
    ...
    question.german = chat_slice.answer
    return chat_slice
